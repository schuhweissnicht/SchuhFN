...
intro = Fore.LIGHTCYAN_EX + """ • BetterFN is made by Schuh weiß nicht
...
async def friends(ctx):
    ...
    try:
        ...
        print(" • Friends List: " + Fore.LIGHTCYAN_EX + f'{len(onlineFriends)} Online ' + Fore.RESET + "/" + Fore.LIGHTBLACK_EX + f' {len(offlineFriends)} Offline ' + Fore.RESET + "/" + Fore.LIGHTWHITE_EX + f' {len(onlineFriends) + len(offlineFriends)} Total')
